...
class Json_Schema {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_ranksmile_get_post_json_schema', array( $this, 'get_json_schema' ) );
		add_action( 'wp_ajax_ranksmile_save_post_json_schema', array( $this, 'save_json_schema' ) );
	...
	public function render_json_schema_meta_box_content() {
		...
		?>
			<div id="ranksmile-json-schema"></div>
		<?php
	}
	...
	public function get_json_schema() {
		...
		$json_schema = get_post_meta( $post_id, '_ranksmile_json_schema', true );
	...
	public function save_json_schema() {
		...
		$t = update_post_meta( $post_id, '_ranksmile_json_schema', $json_schema );

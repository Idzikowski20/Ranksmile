<?php
/**
 * Simple XML logger for Ranksmile import/export operations.
 *
 * @package Ranksmile
...
/**
 * Logger class for Ranksmile operations.
 */
class Ranksmile_Logger {
	...
	public function __construct() {
		...
		$this->log_dir = $upload_dir['basedir'] . '/ranksmile-logs/';
	 ...
	 * @param string $parsed_content Content after parsing for Ranksmile.
	...
	private function write_log( $operation_type, $original_content, $parsed_content, $result, $error_message ) {
		$log_file = $this->log_dir . 'ranksmile-' . $operation_type . '.xml';
	...
	public function get_log_file_path( $operation_type ) {
		return $this->log_dir . 'ranksmile-' . $operation_type . '.xml';
	}
}

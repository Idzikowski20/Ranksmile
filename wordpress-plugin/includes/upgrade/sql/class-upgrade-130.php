...
namespace Ranksmile\Upgrade\SQL;


if ( ! defined( 'ABSPATH' ) ) exit;

use Ranksmile\Upgrade\Database_Upgrade;
...
class Upgrade_130 extends Database_Upgrade {
	...
	public function __construct() {
		...
		$table_name = $wpdb->prefix . 'ranksmile_gsc_traffic';

		$ranksmile_gsc_traffic = '
     ...
     PRIMARY KEY  (id)
		...
		$this->sql[ $table_name ] = $ranksmile_gsc_traffic;
	}
}

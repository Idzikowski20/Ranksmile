...
![Ranksmile](https://i.imgur.com/0S2zIH3.png)

# Ranksmile

![Codacy Badge](https://app.codacy.com/project/badge/Grade/7e7a0030c3f84c6fb56a3ce6273fbc1d) ![GitHub](https://img.shields.io/github/license/towfiqi/ranksmile) ![GitHub package.json version](https://img.shields.io/github/package-json/v/towfiqi/ranksmile) ![Docker Pulls](https://img.shields.io/docker/pulls/towfiqi/ranksmile) [![StandWithPalestine](https://raw.githubusercontent.com/Safouene1/support-palestine-banner/master/StandWithPalestine.svg)](https://www.youtube.com/watch?v=bjtDsd0g468&rco=1)

#### [Documentation](https://ranksmile.pl/) | [Changelog](https://github.com/towfiqi/ranksmile/blob/main/CHANGELOG.md) | [Docker Image](https://hub.docker.com/r/towfiqi/ranksmile)

Ranksmile is an Open Source Search Engine Position Tracking and Keyword Research App. It allows you to track your website's keyword positions in Google and get notified of their position change.

![Easy to Use Search Engine Rank Tracker](https://ranksmile.b-cdn.net/ranksmile_readme_v2.gif)

#### Features

- **Unlimited Keywords:** Add unlimited domains and unlimited keywords to track their SERP.
- **Email Notification:** Get notified of your keyword position changes daily/weekly/monthly through email.
- **SERP API:** Ranksmile comes with built-in API that you can use for your marketing & data reporting tools.
...
The Keyword Research and keyword generation feature works by integrating your Google Ads test accounts into Ranksmile. You can also view the added keyword's monthly search volume data once you [integrate Google Ads](https://ranksmile.pl/miscellaneous/integrate-google-ads).

When you [integrate Google Search Console](https://ranksmile.pl/miscellaneous/integrate-google-search-console), the app shows actual search visits for each tracked keywords. You can also discover new keywords, and find the most performing keywords, countries, pages.you will be able to view the actual visits count from Google Search for the tracked keywords.
...
#### Ranksmile Integrates with popular SERP scraping services

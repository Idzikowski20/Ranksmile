...
import type { CoverageView } from '@/src/core/projections/coverageView';
import type { VisibilityProjection } from '@/src/core/projections/visibilityView';
import type { BenchmarkReport } from '@/src/core/intelligence/benchmark';
import type { JudgeVerdict } from '@/src/core/intelligence/judge';
import type {
  ConsumerContext,
  ConsumerResult,
  ContentConsumer,

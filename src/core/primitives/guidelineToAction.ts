import type { Guideline, GuidelineEffort } from '@/src/infrastructure/engines/recommendationEngine';
import type { Action, ActionCost, ActionType } from '@/src/core/primitives/types';

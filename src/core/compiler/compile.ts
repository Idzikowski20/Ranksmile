...
import { parseTokens } from '@/src/core/compiler/parser';
import { normalizeAst } from '@/src/core/compiler/normalizer';
import { buildSemanticAst } from '@/src/core/compiler/semantic';
import { buildContentIr } from '@/src/core/compiler/irBuilder';
import { assembleCcm } from '@/src/core/compiler/assemble';
import {
  createDraftGraph,
  createPassManager,
...
import { entityPass } from '@/src/core/compiler/passes/entityPass';
import { factPass } from '@/src/core/compiler/passes/factPass';
import { evidencePass } from '@/src/core/compiler/passes/evidencePass';
import { intentPass } from '@/src/core/compiler/passes/intentPass';
import {
...
import { applyConstraintStrip, runConstraints } from '@/src/core/ccm/constraintEngine';
import type { CompileOpts } from '@/src/core/compiler/types';

import type { EntityNode, GraphIndexes, KgEdge, KgNode } from '@/src/core/ccm/types/graph';
import { isEntityNode, isEvidenceSpanNode, isFactNode } from '@/src/core/ccm/types/graph';

import { computeKnowledgeGraphHash } from '@/src/core/ccm/deterministicHash';
import { graphQuery } from '@/src/core/ccm/graphQuery';
import { asObjectId, asPredicateId, asSubjectId } from '@/src/core/ccm/ids';
import type { ActionGraph, EditAction } from '@/src/core/ccm/types/actionGraph';
import type { CanonicalContentModel } from '@/src/core/ccm/types/ccm';
import { isEvidenceSpanNode, isFactNode, type FactNode } from '@/src/core/ccm/types/graph';

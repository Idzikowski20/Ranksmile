...
import type { EditMode, StepFocus } from '@/src/infrastructure/ao/optimizationPlanner';
import { buildEffortOptimizeGuidance } from '@/src/core/domain/terms/contentEffort';
import { buildWhatsMissingOptimizeGuidance } from '@/src/infrastructure/articles/contentScore';
...
export { computeMissingTerms, computeOverusedTerms } from '@/src/infrastructure/ao/optimizeSectionEdit';

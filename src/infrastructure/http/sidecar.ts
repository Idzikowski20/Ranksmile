...
import { isLocalServiceUrl, sidecarUrl } from '@/src/infrastructure/config/serviceUrls';

export { nextjsUrl, publicAppUrl, sidecarUrl } from '@/src/infrastructure/config/serviceUrls';

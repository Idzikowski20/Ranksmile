import { buildCompetitorDocuments } from '@/src/infrastructure/knowledgeEngine/competitorDocument';
import { extractRawKnowledge, isNonClaimSentence, normalizeCandidates } from '@/src/core/domain/knowledgeEngine/extract';
import { canonicalizeClaims, sentencesToCanonicalizeInputs } from '@/src/infrastructure/knowledgeEngine/canonicalize';
import { normalizeClaims, type ClaimCompletion } from '@/src/infrastructure/knowledgeEngine/normalizeClaims';
...
import { buildTopicBlocks, discoverGaps } from '@/src/infrastructure/knowledgeEngine/cluster';

...
import { pickTermsForGeneratedArticle, mergeNlpTerms } from '@/src/infrastructure/pickArticleTerms';
...
import { countOccurrences, computeContentScore, type NlpTerm, type ScoreData } from '@/src/infrastructure/contentScore';

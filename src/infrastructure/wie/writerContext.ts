 ...
 */
import { parseCompetitorSynthesis, formatCompetitorSynthesisForPrompt, type CompetitorSynthesis } from '@/src/infrastructure/wie/competitorSynthesis';
import { buildHeuristicReaderBrief, formatReaderBriefForPrompt, type ReaderBrief } from '@/src/core/domain/wie/readerBrief';
import { buildPolicyContext, resolvePolicyBundle, formatPolicyBundleForPrompt, type PolicyBundle, type PolicyContext } from '@/src/infrastructure/wie/policyResolver';
import { buildNarrativePlan, formatNarrativePlanForPrompt, type NarrativePlan } from '@/src/infrastructure/wie/narrativePlanner';
import { bundleToExplainability, type ExplainabilityRecord } from '@/src/infrastructure/wie/explainability';

 ...
 */
import { fetchPage } from '@/src/infrastructure/siteAudit/auditCompute';
...
import { bumpDnaVersion, readPatternStore, type PatternStoreSnapshot } from '@/src/infrastructure/wie/patternStore';
import { inferIndustry } from '@/src/infrastructure/wie/policyResolver';

...
import type { EditMode, StepFocus } from '@/src/infrastructure/optimizationPlanner';
import { buildEffortOptimizeGuidance } from '@/src/core/domain/terms/contentEffort';
import { buildWhatsMissingOptimizeGuidance } from '@/src/infrastructure/contentScore';
...
export { computeMissingTerms, computeOverusedTerms } from '@/src/infrastructure/optimizeSectionEdit';

...
import { getCompetitors, scanCompetitors } from '@/src/infrastructure/competitorScan';
import { fetchPage, extractFactorValues, RealAuditData, auditContentScore, termScoreFraction } from '@/src/infrastructure/auditCompute';
import type { RichTerm } from '@/src/core/domain/competitors/contentScore';
import { getSearchVolumes } from '@/src/infrastructure/dataforseo';

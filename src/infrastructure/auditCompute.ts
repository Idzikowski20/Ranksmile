...
import { findTermRangesBatch, ScoreData, computeContentScore } from '@/src/infrastructure/contentScore';
...
import { plainText, wordCount } from '@/src/infrastructure/optimizationPlanner';
import {

import { computeContentScore, countOccurrences, type ScoreData } from '@/src/infrastructure/contentScore';
import { liveCoverageItems, remainingOpportunities } from '@/src/infrastructure/liveCoverage';
...
import { paragraphCountFromHtml, scoreArticleHtml } from '@/src/infrastructure/scoreArticleHtml';
...
export { paragraphCountFromHtml } from '@/src/infrastructure/scoreArticleHtml';

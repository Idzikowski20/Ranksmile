...
jest.mock('@/src/infrastructure/articles/articleAiPipeline', () => ({ runArticleAiPipeline: jest.fn() }));
...
jest.mock('@/src/core/domain/aiScore/aiSearchScore', () => ({ computeAiSearchScore: jest.fn() }));

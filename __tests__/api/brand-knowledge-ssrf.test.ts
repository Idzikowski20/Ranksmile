...
jest.mock('@/src/infrastructure/serviceUrls', () => ({ sidecarUrl: jest.fn(() => 'http://sidecar.test') }));
jest.mock('@/src/infrastructure/ssrfGuard', () => ({ assertPublicUrl: jest.fn().mockResolvedValue(new URL('https://example.com')) }));

         ...
         <Head>
            ...
            <style>{`
               *, *::before, *::after { box-sizing: border-box; font-family: "Inter", sans-serif; }
               ...
               .splash { background: #000; min-height: 100vh; display: flex;
                  flex-direction: column; align-items: center; justify-content: center; gap: 1.5rem; }
               .splash-title { margin: 0; font-size: clamp(1.5rem, 6vw, 3.75rem);
                  font-weight: 600; color: #fff; letter-spacing: -0.02em; }
               .splash-spin { width: 28px; height: 28px;
                  border: 3px solid rgba(255,255,255,0.2);
                  border-top-color: #783AFB; border-radius: 50%; animation: sp 0.75s linear infinite; }

...
type Connection = { id: number; site_url: string; org_name: string | null; integrated_by_email: string | null; created_at: string };

/** "a few seconds ago" / "3 minutes ago" / "2 days ago" — small relative formatter. */
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: font }}>
                           ...
                           <tbody>
                              {isLoading ? (
                                 ...
                                 <tr>
                                    <td colSpan={4} style={{ ...td, textAlign: 'center', color: '#71717B', padding: '40px 16px' }}>

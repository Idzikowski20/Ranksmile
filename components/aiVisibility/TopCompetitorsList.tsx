         ...
         {competitors.map((c) => {
            ...
            return (
               <React.Fragment key={c.domain}>
                  ...
                  <button type="button" onClick={() => onSelect(c.domain)} style={{ display: 'flex', alignItems: 'center', gap: 10, width: '100%', border: 'none', background: 'transparent', cursor: 'pointer', padding: 0, fontFamily: FONT }}>

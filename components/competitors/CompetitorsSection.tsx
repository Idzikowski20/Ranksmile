...
const Spinner = () => (
   <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true" style={{ animation: 'spin 0.7s linear infinite' }}>
      ...
      <path d="M21 12a9 9 0 0 0-9-9" stroke="#F84416" strokeWidth="3" strokeLinecap="round" />
   </svg>
);
                                 ...
                                 <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                                    ...
                                    <div style={{ minWidth: 0 }}>
                                       <a
                                          ...
                                          title={c.url}
                                          style={{ display: 'block', fontSize: 12, color: '#F84416', textDecoration: 'none', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}

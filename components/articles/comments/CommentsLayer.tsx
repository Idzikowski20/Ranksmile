...
const CommentsLayer = ({ containerRef, wrapperRef, articleId, author, active, reloadSignal, shareUrl, shareToken, relayoutSignal }: Props) => {
  ...
  return (
    <>
      <style>{'.comment-mark{ text-decoration: underline; text-decoration-color: #F84416; text-decoration-thickness: 2px; text-underline-offset: 2px; background: rgba(242,153,100,0.08); cursor: pointer; } .comment-mark.is-draft{ background: rgba(242,153,100,0.22); cursor: default; }'}</style>

...
const RecommendationsIcon = () => (
  <svg width="42" height="42" viewBox="0 0 42 42" fill="none" aria-hidden="true">
    {/* Wrapped mid-path only to clear max-len — newline is a separator in path data. */}
    <path
      d="M22.2 4.4c.5 5.1 5.8 6.5 7.6 11.2 1.8 4.5.5 10.4-4.6 13.4 1.1-3.5-.4-5.8-2.6-8.2.1 4.9-2.8 7.5-6.5 8.5
         -4.6-2.3-6.7-6.3-5.8-11.2.8-4.6 5.8-7.5 6.5-12.9 2.1 1.4 3.9 3.3 5.4 5.6.6-1.9.5-3.8 0-6.4Z"
      fill="#FF5B49"
    />
  ...
  return (
    <div className="article-list" style={{ display: 'flex', flexDirection: 'column', gap: 8, width: '100%', minWidth: 0, maxWidth: '100%', paddingTop: 20 }}>
      {articles.map((article) => {
        ...
        const wordsLabel = article.word_count != null ? `${article.word_count.toLocaleString()} words` : 'â€”';
        ...
        return (
          ...
          >
            ...
            {/* Main content â€” Figma article card (10218:665879) */}
      ...
      {selectedIds.size > 0 && (
        <div
          ...
          style={{
            ...
            minHeight: 48,
            borderRadius: 8,
            // Foreground must flip with the fill: `--koala-text-on-brand` is #ffffff in
            // every theme, and this surface is near-white in dark and moonlight.

...
const InfoIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" style={{ flexShrink: 0, color: 'var(--koala-text-secondary)' }}>
    <path
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
...
const VisaLogo = () => (
  <svg width="56" height="40" viewBox="0 0 34 24" fill="none" aria-hidden="true" style={{ flexShrink: 0 }}>
    <rect x="0.5" y="0.5" width="33" height="23" rx="3.5" fill="var(--koala-bg-primary)" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      fill="#172B85"
    />
    <rect x="0.5" y="0.5" width="33" height="23" rx="3.5" stroke="var(--koala-border-primary)" />
  </svg>
);

const StripeSeal = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" style={{ flexShrink: 0 }}>
    <circle cx="12" cy="12" r="10" fill="var(--koala-status-success)" />
    <path d="M8 12.2l2.6 2.6L16 9.4" stroke="var(--koala-bg-primary)" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const ReadField = ({ label, value }: { label: string; value: string }) => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
    <span style={{ fontFamily: font, fontSize: 14, color: 'var(--koala-text-primary)' }}>{label}</span>
    <span style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-primary)' }}>{value}</span>
  </div>
);
...
const TaxIdRow = ({ withEdit, onEdit }: { withEdit?: boolean; onEdit?: () => void }) => (
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      <span style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Tax ID</span>
      <InfoIcon />
    </div>
  ...
  return (
    <>
            ...
            {editPayment ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Cardholder Name</label>
                  <Input placeholder="e.g. John Doe" style={{ width: '100%', maxWidth: 320 }} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Card Number</label>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 16, maxWidth: 320 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Expiration Date</label>
                    <Input placeholder="MM/YY" />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>CVC</label>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <VisaLogo />
                <span style={{ fontFamily: font, fontSize: 14, color: 'var(--koala-text-primary)', fontVariantNumeric: 'tabular-nums slashed-zero' }}>
                ...
                <span style={{ fontFamily: font, fontSize: 14, paddingLeft: 8, fontVariantNumeric: 'tabular-nums slashed-zero' }}>
                  <span style={{ color: 'var(--koala-text-secondary)' }}>Exp:</span> 4/2031
                </span>
              </div>
            )}
          </div>
      ...
      <KoalaSettingsSection title="Customer details">
        <KoalaSettingsRow label="Billing information" description="Address and tax details used on invoices.">
          <div style={{ width: '100%' }}>
            ...
            {editCustomer ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 420 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Country</label>
                  <div style={{ width: '100%', boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--koala-bg-tertiary)', border: '1px solid var(--koala-border-primary)', borderRadius: 8, padding: '10px 12px', fontFamily: font, fontSize: 14, color: 'var(--koala-text-secondary)' }}>
                    <span>Poland</span>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Billing email (optional)</label>
                  <Input defaultValue="patryk.idzikowski@interia.pl" style={{ width: '100%' }} />
                  <span style={{ fontFamily: font, fontSize: 13, color: 'var(--koala-text-secondary)' }}>Fill in to receive invoices on an email address other than the one associated with your account</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Name/Company name</label>
                  <Input style={{ width: '100%' }} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>Address</label>
                  <Input style={{ width: '100%' }} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>City</label>
                  <Input style={{ width: '100%' }} />
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr)', gap: 16 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>State/Province/Region</label>
                    <Input />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <label style={{ fontFamily: font, fontSize: 14, fontWeight: 500, color: 'var(--koala-text-secondary)' }}>ZIP Code</label>
                    <Input />
                  </div>
                </div>

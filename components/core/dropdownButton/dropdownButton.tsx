...
export function DropdownButton({
  ...
  return (
    ...
    >
      {prefix && (
        <span className="sentry-dropdown-button-prefix">{prefix}</span>
      )}
      <span className="sentry-dropdown-button-label">{children}</span>
      {showChevron && (
        <span className="sentry-dropdown-button-chevron">

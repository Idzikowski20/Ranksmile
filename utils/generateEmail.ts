...
const ranksmileLogo = 'https://ranksmile.b-cdn.net/ikAdjQq.png';
const mobileIcon = 'https://ranksmile.b-cdn.net/SqXD9rd.png';
const desktopIcon = 'https://ranksmile.b-cdn.net/Dx3u0XD.png';
const googleIcon = 'https://ranksmile.b-cdn.net/Sx3u0X9.png';
...
const generateEmail = async (domainName:string, keywords:KeywordType[], settings: SettingsType) : Promise<string> => {
   ...
   const updatedEmail = emailTemplate
         .replace('{{logo}}', `<img class="logo_img" src="${ranksmileLogo}" alt="Ranksmile" width="24" height="24" />`)
